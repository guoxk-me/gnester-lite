// CN: 服务，承载 demo-cors 的业务逻辑；EN: Service holds business logic for demo-cors.
...
export class DemoCorsService {
  // CN: 执行 demo-cors 的 get scenarios 业务逻辑；EN: Runs the get scenarios business logic for demo-cors.
  ...
  // CN: 执行 demo-cors 的 get public resource 业务逻辑；EN: Runs the get public resource business logic for demo-cors.
  ...
  // CN: 执行 demo-cors 的 get credentialed resource 业务逻辑；EN: Runs the get credentialed resource business logic for demo-cors.
